...
import ec.com.kruger.bean.factura.LiquidacionCompras;
...
public class DocumentTransformUtilImpl implements DocumentTransformUtil, Serializable {
	...
	public static LiquidacionCompras obtenerLiquidacionCompra(String pLiquidacionCompra) throws Exception {
		CabeceraLiquidacionCompras cabecera = new CabeceraLiquidacionCompras();
		
		List<String> lista = Arrays.asList(pLiquidacionCompra.split(BREAL_LINE));
