...
public class AdicionalND implements Serializable {
	...
	public String getFillerAdND() {
		return this.fillerAdND;
	}

	public void setFillerAdND(String fillerAdND) {
		this.fillerAdND = fillerAdND;
	}
